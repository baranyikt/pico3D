; full-featured COM version
org 100h						; DIFFERS-from-boot-version [different load offset]
cpu 386
use16
...
keyPress:
	...
	cmp ah, UP_ARROW
	je keyPress_forward
	cmp ah, DOWN_ARROW			; DIFFERS-from-boot-version [backwards enabled]
	je keyPress_backward
	cmp ah, LEFT_ARROW
	je keyPress_turnLeftRight
	cmp ah, RIGHT_ARROW
	je keyPress_turnLeftRight
	cmp ah, SLIDE_LEFT			; DIFFERS-from-boot-version [sliding enabled]
...
keyPress_backward:				; DIFFERS-from-boot-version [backwards enabled]
...
keyPress_slideLeft:				; DIFFERS-from-boot-version [sliding enabled]
